<template>
  ...
  >
      ...
      <form class="space-y-4" @submit.prevent="onSubmit">
        <ImageField :imageUrl="userService.authenticatedUserImage!"/>
        <FirstNameField />
        <LastNameField />
        <BaseButton
