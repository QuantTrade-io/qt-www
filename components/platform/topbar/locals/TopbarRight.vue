<template>
  <div class="flex justify-end flex-1">
    ...
    <Menu as="div" class="relative">
      ...
      >
        <MenuItems
          class="absolute right-0 z-10 mt-2.5 w-32 p-2 origin-top-right rounded-md bg-white dark:bg-slate-700 py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none"
        >
