      ...
      <main>
        ...
        <div class="divide-y divide-white/5">
          <div class="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8">
            <div>
              <h2 class="text-base font-semibold leading-7 text-white">Platform Preferences</h2>
              <p class="mt-1 text-sm leading-6 text-gray-400">Settings that should be reflected throughout the Platform.</p>
            </div>
